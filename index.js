...
let startQuiz = async () => {
    ...
    for (let i = 1; i <= 5; i++) {
        ...
        if (ans.quiz == data[i].correct_answer) {
            ...
            console.log(`correct answer is ${chalk.bold.
                italic.red(data[i].correct_answer)}`);
        }
    }
    console.log(`dear ${chalk.green.bold(name.hello)},your score is ${chalk.red.bold(score)}out of ${chalk.red.bold('5')}`);
};
startQuiz();
